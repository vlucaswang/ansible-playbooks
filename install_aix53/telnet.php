...
// test simple
	...
	$telnet->write("ls -l");       $telnet->wait_prompt();
	$telnet->write("uncompress /tmp/ansible/openssh_5.2p1_aix53.tar.Z"); $telnet->wait_prompt();
	$telnet->write("tar xf openssh_5.2p1_aix53.tar");                $telnet->wait_prompt();
	$telnet->write("rpm -ivh openssl-1.0.1e-2.aix5.1.ppc.rpm");      $telnet->wait_prompt();
	$telnet->write("installp -aX -d /tmp/ansible ALL");                  $telnet->wait_prompt();

	$telnet->write("cd aixpack");                                    $telnet->wait_prompt();
	$telnet->write("installp -aX -d /tmp/ansible/aixpack ALL");      $telnet->wait_prompt();
	$telnet->write("exit");
	$telnet->disconnect(); 

	echo "Okey, please view log/telnet.log ";
?> 
